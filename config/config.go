...
// Config is implemented by every provider config in this package. The marker
// method keeps storage.New's argument type-checked while letting these structs
// live in a package that pulls in no provider SDKs.
...
func (*AliOSSConfig) storageConfig() {}
...
func (*AzureConfig) storageConfig() {}
